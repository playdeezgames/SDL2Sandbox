...
namespace Constants
{
	...
	namespace PickUp
	{
		...
		const int MINIMUM_RANDOM_COLUMN = 1;
		const int MAXIMUM_RANDOM_COLUMN = Constants::Board::COLUMNS - 2;
		const int DIAMOND_BONUS = 500;
		const int PENNY_BONUS = 1;
		const int DOLLAR_BONUS = 100;
		const int POUND_BONUS = 500;
		const int YEN_BONUS = 1000;
	}
	namespace Tail
	{
		const int LENGTH = 6;
	...
	namespace Sound
	{
		namespace Name
		{
			...
			const std::string DEATH = "dead";
			const std::string CHOMP = "chomp";
			const std::string TING = "ting";
		...
		namespace FileName
		{
			...
			const std::string TING = "assets/sounds/ting.wav";
			const std::string CHARGE = "assets/sounds/charge.wav";
